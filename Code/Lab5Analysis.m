...
coords = [0.0000, 0.0036, 0.0306, 0.0494, 0.0735, 0.0962, 0.1201, 0.1452, 0.1921, 0.2944, 0.3746, 0.4365, 0.5023, 0.6130, 0.6569, 0.7093, 0.8004, 0.8348, 0.8759, 0.9367, 1.0000 0.9321, 0.8549, 0.8059, 0.7552, 0.7042, 0.6551, 0.6013, 0.5496, 0.5003, 0.4492, 0.3982, 0.3503, 0.2992, 0.2493, 0.2040, 0.1487, 0.1256, 0.0980, 0.0734, 0.0385, 0.0207, 0.0063, 0;
0.0000, -0.0126, -0.0293, -0.0355, -0.0418, -0.0462, -0.0502, -0.0539, -0.0585, -0.0641, -0.0653, -0.0640, -0.0609, -0.0486, -0.0415, -0.0322, -0.0158, -0.0105, -0.0056, -0.0023, 0.0000 0.0177, 0.0386, 0.0514, 0.0639, 0.0755, 0.0851, 0.0935, 0.0992, 0.1027, 0.1045, 0.1047, 0.1036, 0.1015, 0.0979, 0.0930, 0.0838, 0.0792, 0.0725, 0.0651, 0.0503, 0.0383, 0.0227,0];

coordsplot = [0.0000, 0.0036, 0.0306, 0.0494, 0.0735, 0.0962, 0.1201, 0.1452, 0.1921, 0.2944, 0.3746, 0.4365, 0.5023, 0.6130, 0.6569, 0.7093, 0.8004, 0.8348, 0.8759, 0.9367, 1.0000 0.9321, 0.8549, 0.8059, 0.7552, 0.7042, 0.6551, 0.6013, 0.5496, 0.5003, 0.4492, 0.3982, 0.3503, 0.2992, 0.2493, 0.2040, 0.1487, 0.1256, 0.0980, 0.0734, 0.0385, 0.0207, 0.0063;
0.0000, -0.0126, -0.0293, -0.0355, -0.0418, -0.0462, -0.0502, -0.0539, -0.0585, -0.0641, -0.0653, -0.0640, -0.0609, -0.0486, -0.0415, -0.0322, -0.0158, -0.0105, -0.0056, -0.0023, 0.0000 0.0177, 0.0386, 0.0514, 0.0639, 0.0755, 0.0851, 0.0935, 0.0992, 0.1027, 0.1045, 0.1047, 0.1036, 0.1015, 0.0979, 0.0930, 0.0838, 0.0792, 0.0725, 0.0651, 0.0503, 0.0383, 0.0227];
%% Average upload
...
AverageAE = [deg4NAE;deg0AE;deg4AE;deg6AE;deg8AE;deg10AE;deg12AE;deg14AE;deg16AE];
...
for i = 1:9
    ...
    delM(i,:) = (-(average_pressure(i,:).*middle_coord(1,:)).*half_coord(1,:)-(average_pressure(i,:).*middle_coord(2,:)).*half_coord(2,:));
...
for i = 1:9
    ...
    Lift_per_unit(i,:) = NSum(i,:).*cosd(AOA(i,:))+ASum(i,:).*sind(AOA(i,:)); 
    Drag_per_unit(i,:) = NSum(i,:).*sind(AOA(i,:))-ASum(i,:).*cosd(AOA(i,:)); 
...
figure(1)
plot(AOA,C_l,"Black","LineWidth",2)
title("C_L Vs AOA","FontSize",20)
xlabel("Angle Of Attack","FontSize",16)
ylabel("C_L","FontSize",16)
grid on 
figure(2)
plot(AOA,C_d,"black","LineWidth",2)
title("C_D Vs AOA","FontSize",20)
xlabel("Angle Of Attack","FontSize",16)
ylabel("C_D","FontSize",16)
grid on 
figure(3)
plot(AOA,C_m,"Black","LineWidth",2)
title("C_m Vs AOA","FontSize",20)
xlabel("Angle Of Attack","FontSize",16)
...
title("C_p Vs -4 degree AOA","FontSize",20)
xlabel("Normalized X-cordinate","FontSize",16)
...
hold off
set (gca,'YDir','reverse')
title("C_p Vs 0 degree AOA","FontSize",20)
xlabel("Normalized X-cordinate","FontSize",16)
ylabel("C_P","FontSize",16)
grid on
legend("Bottom Surface","Upper Surface")
...
hold off
set (gca,'YDir','reverse')
title("C_p Vs 6 degree AOA","FontSize",20)
xlabel("Normalized X-cordinate","FontSize",16)
ylabel("C_P","FontSize",16)
grid on
legend("Bottom Surface","Upper Surface")
...
hold off
set (gca,'YDir','reverse')
title("C_p Vs 8 degree AOA","FontSize",20)
xlabel("Normalized X-cordinate","FontSize",16)
ylabel("C_P","FontSize",16)
grid on
legend("Bottom Surface","Upper Surface")
...
hold off
set (gca,'YDir','reverse')
title("C_p Vs 10 degree AOA","FontSize",20)
xlabel("Normalized X-cordinate","FontSize",16)
ylabel("C_P","FontSize",16)
grid on
legend("Bottom Surface","Upper Surface")
...
hold off
set (gca,'YDir','reverse')
title("C_p Vs 12 degree AOA","FontSize",20)
xlabel("Normalized X-cordinate","FontSize",16)
ylabel("C_P","FontSize",16)
grid on
legend("Bottom Surface","Upper Surface")
...
hold off
set (gca,'YDir','reverse')
title("C_p Vs 14 degree AOA","FontSize",20)
xlabel("Normalized X-cordinate","FontSize",16)
ylabel("C_P","FontSize",16)
grid on
legend("Bottom Surface","Upper Surface")
...
hold off
set (gca,'YDir','reverse')
title("C_p Vs 16 degree AOA","FontSize",20)
xlabel("Normalized X-cordinate","FontSize",16)
ylabel("C_P","FontSize",16)
grid on
legend("Bottom Surface","Upper Surface")
